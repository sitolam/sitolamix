...
from aqt import QAction, QKeySequence
...
def copyCard(old_card:Card, new_card:Card):
    oid = old_card.id
...
def _uniquifyNote(self, note:Note):
    global firstBug
    srcMid = note[MID]
