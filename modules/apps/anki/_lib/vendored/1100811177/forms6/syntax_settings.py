...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lab_style_nm = QtWidgets.QLabel(Dialog)
        self.lab_style_nm.setObjectName("lab_style_nm")
        self.horizontalLayout_11.addWidget(self.lab_style_nm)
        self.lab_style_selected_nm = QtWidgets.QLabel(Dialog)
        self.lab_style_selected_nm.setObjectName("lab_style_selected_nm")
        self.horizontalLayout_11.addWidget(self.lab_style_selected_nm)
        self.pb_setstyle_nm = QtWidgets.QPushButton(Dialog)
        self.pb_setstyle_nm.setObjectName("pb_setstyle_nm")
        self.horizontalLayout_11.addWidget(self.pb_setstyle_nm)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cb_showPreCode.setText(_translate("Dialog", "show unformatted (<pre>, <code>). This might be broken depending on the Anki version you use"))
        ...
        self.lab_style_nm.setText(_translate("Dialog", "Style (Night Mode):"))
        self.lab_style_selected_nm.setText(_translate("Dialog", "needs to be configured"))
        self.pb_setstyle_nm.setText(_translate("Dialog", "Change"))
